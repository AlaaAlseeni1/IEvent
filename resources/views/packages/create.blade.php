        ...
        <form action="{{ route('packages.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="type" class="form-select" required>
                        @foreach(\App\Models\Package::TYPES as $key => $label)
                            <option value="{{ $key }}" {{ old('type','monthly')==$key?'selected':'' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="price" class="form-control" value="{{ old('price', 0) }}" min="0">
                </div>
                <div class="col-md-4">
